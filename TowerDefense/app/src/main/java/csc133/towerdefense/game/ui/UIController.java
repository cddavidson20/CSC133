...
public class UIController implements IInputObserver {
    public UIController(IGameEngineBroadcaster b) {
        b.addObserver(this);
    }
    ...
    UIController(IGameEngineBroadcaster b, Point size) {
        // Add as an observer
        addObserver(b);
    ...
    public void addObserver(IGameEngineBroadcaster b) {
        b.addObserver(this);
    }
